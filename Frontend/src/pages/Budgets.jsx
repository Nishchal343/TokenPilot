...
import { Check, CircleDollarSign, Eye, KeyRound, X, Activity, Clock3, ShieldCheck, Users } from 'lucide-react'
...
function TeamLeaderRequests() {
  ...
  return <div className="dashboard">
    ...
    <div className="approval-metrics"><Metric icon={Clock3} label="Awaiting review" value={pending} tone="purple"/><Metric icon={CircleDollarSign} label="Requested allocation" value={totalBudget.toLocaleString()} tone="blue"/><Metric icon={Users} label="Team members" value="—" tone="green"/><Metric icon={ShieldCheck} label="Policy status" value="Healthy" tone="orange"/></div>
...
function CompanyApprovalCenter() {
  ...
  return <div className="dashboard">
    ...
    <div className="approval-metrics"><Metric icon={Clock3} label="Awaiting approval" value={pending} tone="purple"/><Metric icon={CircleDollarSign} label="Budget in review" value={allocated.toLocaleString()} tone="blue"/><Metric icon={ShieldCheck} label="Active access" value={active} tone="green"/><Metric icon={Activity} label="Workflow" value="2-step" tone="orange"/></div>
